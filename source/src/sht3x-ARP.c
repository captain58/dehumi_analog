...
#define CON_SHT3X_ARP_TEMP_FACTOR  (-66.875)
#define CON_SHT3X_ARP_TEMP_MULTI  (218.75)
int16_t GetTempFromAdc(uint32_t uiTemp) {
    float fVer = 0;

    fVer = (float)CON_SHT3X_ARP_TEMP_FACTOR + (float)uiTemp * CON_SHT3X_ARP_TEMP_MULTI  / HC32_ADC_FULL;

    return (int16_t)(fVer * 100);
}

#define CON_SHT3X_ARP_HUM_FACTOR  (-12.5)
#define CON_SHT3X_ARP_HUM_MULTI  (125)
...
uint16_t GetHumFromAdc(int16_t iTemp, uint32_t uiHum) {
    ...
    float fVer = (float)CON_SHT3X_ARP_HUM_FACTOR + (float)uiHum * CON_SHT3X_ARP_HUM_MULTI  / HC32_ADC_FULL;

    return (uint16_t)(fVer * 100);
